...
dividir
    it('quando a divisao for correta', function() {
      expect(dividir(6 , 2)).toBe(3);
    });

    it('quando a divisao for por zero', function() {
      expect(dividir(0 ,2 )).toBe(0);
    });

    it('quando a divisao for feita por numeros negativos', function() {
      expect(dividir(-2 ,-2)).toBe(1);
    });
    it('quando a divisao for feita por numeros negativose e positivos ', function() {
      expect(dividir(2 ,-2)).toBe(-1);
    });
    it('deve retornar NaN ao adicionar valores inválidos', function() {
